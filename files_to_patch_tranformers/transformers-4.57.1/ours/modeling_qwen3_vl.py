...
class Qwen3VLModel(Qwen3VLPreTrainedModel):
    ...
    def forward(
        ...
        video_grid_thw: Optional[torch.LongTensor] = None,
        cache_position: Optional[torch.LongTensor] = None,
        pre_calculated_visual_embedding: Optional[torch.FloatTensor] = None,
        pre_calculated_visual_embedding_deepstack = None,
        **kwargs: Unpack[TransformersKwargs],
        ...
        if pixel_values_videos is not None or pre_calculated_visual_embedding is not None:
            if pre_calculated_visual_embedding is not None:
                video_embeds = pre_calculated_visual_embedding.to(inputs_embeds.device, inputs_embeds.dtype)
                deepstack_video_embeds = [ v.to(inputs_embeds.device, inputs_embeds.dtype) for v in pre_calculated_visual_embedding_deepstack ]
            else:
    ...
    def prepare_inputs_for_generation(
        ...
        **kwargs,
        ...
        if cache_position[0] != 0:
            ...
            model_inputs["pre_calculated_visual_embedding"] = None
            model_inputs["pre_calculated_visual_embedding_deepstack"] = None
            model_inputs["position_ids"] = None
        else:
            model_inputs["pre_calculated_visual_embedding"] = pre_calculated_visual_embedding
            model_inputs["pre_calculated_visual_embedding_deepstack"] = pre_calculated_visual_embedding_deepstack
