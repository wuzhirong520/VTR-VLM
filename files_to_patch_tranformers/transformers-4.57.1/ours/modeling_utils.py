...
from .pytorch_utils import apply_chunking_to_forward as apply_chunking_to_forward_new
from .pytorch_utils import find_pruneable_heads_and_indices as find_pruneable_heads_and_indices_new
from .pytorch_utils import prune_linear_layer as prune_linear_layer_new
def apply_chunking_to_forward(*args, **kwargs):
    return apply_chunking_to_forward_new(*args, **kwargs)
def find_pruneable_heads_and_indices(*args, **kwargs):
    return find_pruneable_heads_and_indices_new(*args, **kwargs)
def prune_linear_layer(*args, **kwargs):
    return prune_linear_layer_new(*args, **kwargs)
