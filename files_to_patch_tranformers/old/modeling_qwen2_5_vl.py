        ...
        if input_ids is not None and (image_grid_thw is not None or video_grid_thw is not None):
            ...
            for i, input_ids in enumerate(total_input_ids):
                ...
                for _ in range(image_nums + video_nums):
                    ...
                    time_tensor = expanded_range * float(second_per_grid_t) * self.config.vision_config.tokens_per_second
        ...
        model_inputs.update(
            {
                ...
                "pre_calculated_visual_embedding" : pre_calculated_visual_embedding,
            }
        )
        return model_inputs
